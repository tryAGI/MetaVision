...
namespace MetaVision
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::MetaVision.AutoSDKRetryOptions Retry { get; set; } = new global::MetaVision.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::MetaVision.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::MetaVision.IAutoSDKHook>();
        ...
        public global::MetaVision.AutoSDKClientOptions AddHook(
            global::MetaVision.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::MetaVision.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::MetaVision.AutoSDKClientOptions UseAuthorizationProvider(
            global::MetaVision.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::MetaVision.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::MetaVision.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::MetaVision.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::MetaVision.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::MetaVision.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::MetaVision.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::MetaVision.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::MetaVision.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::MetaVision.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::MetaVision.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::MetaVision.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::MetaVision.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::MetaVision.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::MetaVision.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::MetaVision.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::MetaVision.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::MetaVision.AutoSDKClientOptions clientOptions,
            global::MetaVision.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::MetaVision.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::MetaVision.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::MetaVision.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::MetaVision.AutoSDKClientOptions clientOptions,
            global::System.Func<global::MetaVision.IAutoSDKHook, global::MetaVision.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::MetaVision.AutoSDKHookContext context)
        {
