...
The MetaVision SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package MetaVision
```
...
using var client = new MetaVisionClient(
    apiKey: Environment.GetEnvironmentVariable("METAVISION_API_KEY")!);
